...
context = """
você irá operar como assistente de suporte da Samsung. Garanta que você possa oferecer suporte ao cliente em relação aos produtos e à empresa de maneira profissional, educada e informativa. 
...
while True:
  if not query:
    query = input("Prompt: ")
  if query in ['quit', 'exit', 'sair']:
    sys.exit()
  result = chain({"question": query + "" + context, "chat_history": chat_history})
  print(result['answer'])
